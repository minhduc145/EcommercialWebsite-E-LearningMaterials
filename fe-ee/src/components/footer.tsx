  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 bg-zinc-900 dark:bg-zinc-100">
      <div className="container mx-auto px-4 md:px-6 flex flex-col items-center text-center">
        <h2 className="text-2xl p-2 font-bold tracking-tighter sm:text-3xl md:text-4xl lg:text-5xl/none text-white">
          Stay Connected
        </h2>
        <p className="mx-auto max-w-[700px] text-zinc-100 md:text-lg dark:text-zinc-800">
          Leave your email here to get supported!
        </p>
        <div className="w-full max-w-md space-y-2 my-4">
          <form className="flex space-x-2">
            ...
            <Button type="submit" variant="outline" className="text-black border-white">
              Submit
            </Button>
          </form>
        </div>
        <div className="flex justify-center space-x-4">
          ...
          <Link href="#" aria-label="Google profile" className="text-white" prefetch={false}>
